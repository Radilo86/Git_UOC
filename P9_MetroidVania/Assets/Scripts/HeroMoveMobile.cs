...
public class HeroMoveMobile : MonoBehaviour
{
    ...
    public bool betterJump = true; // Nos va a permitir activar o desactivar este tipo de salto.
    ...
    void Update()
    {
        ...
        if (joystick.Vertical >= .2f && Grounded)
        {
            Jump();
        }
    ...
    private void Jump()
    {
        gameObject.GetComponent<Rigidbody2D>().AddForce(new Vector2(0f, 2.2f), ForceMode2D.Impulse);
    }
